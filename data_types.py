...
print(type(max_salary_))
print(type(min_salary_))
print(type(insurance_empl_))
print(type(salary_budge_))
print(type(location_city_))
print(type(director_fr_name_))
print(type(director_ls_name_))
